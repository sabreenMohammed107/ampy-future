                  ...
                  <div class="box-body">
                        ...
                        <div class="form-group">
                            <label  >{{ __('  الشهر باللغة العربية ') }}</label>
                                <input type="text" id="newTitle" name="month_ar" value="{{old('month_ar')}}" class="form-control"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label  >{{ __('  الشهر باللغة الانجليزية ') }}</label>
                                    <input type="text" id="newTitle" name="month_en" value="{{old('month_en')}}" class="form-control"
